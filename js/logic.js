...
// creates a function called someSmartName that takes a single parameter: param
  ...
  if (randonNum == 1) {       // if the random number equals 1
    result = 'tails';          // call the result 'tails'
  } else {                    // otherwise
    result = 'heads';         // call the result 'heads'
  };                          
  ...
  // conditional statement 
  if (userChoice === result) {    // if values of the coin flip and player choice match,
